  ...
  return (
    <div>
      ...
      <div className="page">
        ...
        {isStudentCombo && (
          <div className="card" style={{ marginTop: 16, background: '#FBE9CF' }}>
            <span style={{ fontSize: 13 }}>
              🎓 Phần này dành riêng cho khách đang là sinh viên/học sinh — quán sẽ kiểm tra lại thẻ sinh viên/CCCD khi giao hàng.
            </span>
          </div>
        )}
